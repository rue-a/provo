...
def link(self, inputs = None, process = None, outputs = None, agents = None, inference = True):
        """ Helper method to create properties according to PROV-O links Agents, Input Entities, Output Entities and a 
        single Activity.
        It also adds wasInformedBy properties between activities, if needed.
